...
const Header = () => {
    ...
    return(
        <header className='flex bg-gray-dark py-4 sm:px-10 px-6 font-[sans-serif] min-h-[80px] tracking-wide relative z-50'>
            <div className='flex flex-wrap items-center lg:gap-y-2 gap-4 w-full'>
                ...
                <div id="collapseMenu"
                    className={`lg:ml-12 lg:block ${menuOpen ? 'block' : 'hidden'} lg:max-lg:hidden lg:!block max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50`}>
                    ...
                    <ul
                    className='lg:flex lg:gap-x-3 max-lg:space-y-3 max-lg:fixed max-lg:bg-gray-dark max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
                    <li className='mb-6 hidden max-lg:block'>
                        <a href="javascript:void(0)"><img src={logo} alt="logo" className='w-10' />
                        </a>
                    </li>
                ...
                <div className="flex gap-x-6 gap-y-4 ml-auto">
                    ...
                    <span className="relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" className="cursor-pointer fill-[#FFFFFF] inline"
                        viewBox="0 0 64 64">
                        <path
                    ...
                    <span className="relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="cursor-pointer fill-[#FFFFFF] inline"
                        viewBox="0 0 512 512">
                        <path
