...
const Footer = () => {
    return(
        <footer class="bg-gray-dark py-12 px-16 font-[sans-serif]">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    <h2 class="text-white text-lg font-bold mb-4">SERVICE</h2>
                    <ul class="space-y-3">
                        <li>
                        <a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base transition-all">Shipping information</a>
                        </li>
                        <li>
                        <a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base transition-all">Withdrawal form</a>
                        </li>
                        <li>
                        <a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base transition-all">Warranty Claim</a>
                        </li>
                    </ul>
                </div>
                <div>
                    <h2 class="text-white text-lg font-bold mb-4">HELP & TIPS</h2>
                    <ul class="space-y-3">
                        <li>
                        <a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base transition-all">Support</a>
                        </li>
                        <li>
                        <a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base transition-all">FAQ</a>
                        </li>
                        <li>
                        <a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base transition-all">Bike assembly videos</a>
                        </li>
                    </ul>
                </div>
                <div>
                ...
                <div class="flex items-center lg:justify-center">
                    <a href='javascript:void(0)'><img src={logo} alt="logo" class='w-60' /></a>
                </div>
            </div>
            <hr class="my-8 border-gray-700" />
            <div class="sm:flex sm:items-center sm:justify-between sm:flex-row">
                <p class='text-gray-400 text-sm sm:order-1'>© 2024<a href='https://github.com/davikomura' target='_blank'
                class="hover:underline mx-1">DK Cycle Shop</a>All Rights Reserved.
                </p>
