...
export const Signup = () => {
  return (
    <div class="font-[sans-serif] bg-gray-dark flex items-center md:h-screen p-4">
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-center">
                ...
                <label for="remember-me" class="text-gray-800 ml-3 block text-sm">
                  I accept the <a href="javascript:void(0);" class="text-primary-600 font-semibold hover:underline ml-1">Terms and Conditions</a>
                </label>
              </div>
            </div>

            <div class="!mt-8">
              <button type="button" class="w-full py-2.5 px-4 text-sm tracking-wider font-semibold rounded-md bg-[#FF6347] hover:bg-[#FF7F50] text-white focus:outline-none">
                Create Account
              </button>
            </div>
            <p class="text-gray-800 text-sm mt-6 text-center">Already have an account? <a href="javascript:void(0);" class="text-primary-600 font-semibold hover:underline ml-1"><Link to="/Login">Login here</Link></a></p>
          </form>
        </div>
      </div>
    </div>
